                ...
                (function () {
                    this.jKanban = function () {
                                ...
                                self.drake = self
                                    ...
                                    .on("drag", function (el, source) {
                                        ...
                                        if (boardJSON.dragTo !== undefined) {
                                            self.options.boards.map(function (
                                                board
                                            ) {
                                                if (
                        ...
                        this.addElement = function (boardID, element) {
                            ...
                            nodeItem.innerHTML = __buildItemTitle(
                                element.title
                            );
                        ...
                        this.addBoards = function (boards, isInit) {
                            if (self.options.responsivePercentage) {
                                ...
                                if (
                                    window.innerWidth > self.options.responsive
                                ) {
                                    var boardWidth =
                                        (100 - boards.length * 2) /
                                        boards.length;
                            ...
                            for (var boardkey in boards) {
                                ...
                                boardNode.dataset.order =
                                    self.container.childNodes.length + 1;
                                ...
                                boardNode.style.marginLeft =
                                    self.options.gutter;
                                boardNode.style.marginRight =
                                    self.options.gutter;
                                var headerBoard =
                                    document.createElement("header");
                                if (
                                    board.class !== "" &&
                                    board.class !== undefined
                                )
                                    var allClasses = board.class.split(",");
                                else allClasses = [];
                                headerBoard.classList.add(
                                    "kanban-board-header"
                                );
                                ...
                                if (addButton) {
                                    ...
                                    var t =
                                        document.createTextNode(buttonContent);
                                    btn.setAttribute(
                                        "class",
                                ...
                                if (
                                    board.bodyClass !== "" &&
                                    board.bodyClass !== undefined
                                )
                                    var bodyClasses =
                                        board.bodyClass.split(",");
                                else bodyClasses = [];
                                ...
                                for (var itemkey in board.item) {
                                    ...
                                    if (
                                        itemKanban.class &&
                                        Array.isArray(itemKanban.class)
                                    ) {
                                    ...
                                    __appendCustomProperties(
                                        nodeItem,
                                        itemKanban
                                    );
                                    __onclickHandler(nodeItem);
                                    if (
                                        self.options.itemHandleOptions.enabled
                                    ) {
                                        nodeItem.style.cursor = "default";
                                    }
                        ...
                        this.moveElement = function (
                            ...
                            if (
                                targetBoardID ===
                                this.getParentBoardID(elementID)
                            ) {
                                return;
                            }
                        ...
                        function __setBoard() {
                            self.element = document.querySelector(
                        ...
                        function __appendCustomProperties(
                            element,
                            parentObject
                        ) {
                            for (var propertyName in parentObject) {
                                if (
                                    self._disallowedItemProperties.indexOf(
                                        propertyName
                                    ) > -1
                                ) {
                                    continue;
                        ...
                        function __updateBoardsOrder() {
                            ...
                            for (
                                var i = 0;
                                i < self.container.childNodes.length;
                                i++
                            ) {
                                self.container.childNodes[i].dataset.order =
                                    index++;
                            }
                        }
                        function __buildItemTitle(title) {
                            ...
                            if (self.options.itemHandleOptions.enabled) {
                                if (
                                    (self.options.itemHandleOptions
                                    ...
                                    if (
                                        (customCssHandler || undefined) ===
                                        undefined
                                    ) {
                                        customCssHandler = "drag_handler";
                                    }
                                    if (
                                        (customCssIconHandler || undefined) ===
                                        undefined
                                    ) {
                                        customCssIconHandler =
                                            customCssHandler + "_icon";
                                    }
                                    result =
                                    ...
                                    result =
                                        self.options.itemHandleOptions.customHandler.replace(
                                            "%s",
                                            result
                                        );
                                }
