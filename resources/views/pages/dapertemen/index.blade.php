...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dapertemen</li>
            </ol>
        </nav>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Dapertemen</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Dapertemen</h5>
...
@push('script')
    ...
    <script>
        ...
        $jquery(document).on('click', '#edit', function(e) {
            ...
            $jquery.ajax({
                type: "GET",
                url: "{{ route('dapertemen.getDataById') }}",
                data: {
                    id: id,
                    _token: "{{ csrf_token() }}"
                },
